...
function CreateCabinForm({ cabinToEdit = {}, setShowEditForm }) {
  ...
  const { register, handleSubmit, reset, getValues, formState } = useForm({
    defaultValues: isEditSection ? editValue : {},
  });
    ...
    <Form onSubmit={handleSubmit(onSubmit, onError)}>
      ...
      <FormRow label="Regular price" error={errors?.regularPrice?.message}>
        <Input
          ...
          {...register("regularPrice", {
            ...
            min: {
              value: 1,
              message: "Regular Price should be a least 1.",
            },
          })}
        />
      </FormRow>
      ...
      <FormRow label="Cabin photo">
        <FileInput
          ...
          accept="image/*"
          {...register("image", {
            required: isEditSection ? false : "This field is required!",
          })}
        />
      </FormRow>
      ...
      <FormRow>
        ...
        <Button disabled={isWorking}>
          {isEditSection ? "Edit Cabin" : "Add New Cabin"}
        </Button>
      </FormRow>
    </Form>
  );
